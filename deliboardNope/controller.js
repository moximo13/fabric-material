...
return{
	...
	add_request: function(req, res){
		...
		var sender_name = array[1]
		var sender_address = array[2]
		var receive_name = array[3]
		var receive_address = array[4]
		var deliverer_name = array[5]
		var price = array[6]
		var status = array[7]
		var code = array[8]
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
				...
				args: [timestamp, sender_name, sender_address, receive_name, receive_address, deliverer_name, price, status, code],
